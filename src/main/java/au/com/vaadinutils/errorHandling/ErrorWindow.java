...
public class ErrorWindow
{
    ...
    private void internalShowErrorWindow(Throwable error)
    {
        ...
        logger.error(
                "Reference: " + reference + " Version: " + getBuildVersion() + " System: " + getSystemName() + " " + error,
                error);
    ...
    private void displayVaadinErrorWindow(final String causeClass, final String id, final Date time, final String finalId,
            final String finalTrace, final String reference)
    {
        ...
        final Screenshot screenshot = Screenshot.newBuilder().withLogging(true).withMimeType(ScreenshotMimeType.PNG).build();
    ...
    private void showWindow(String causeClass, String id, final Date time, final String finalId, final String finalTrace,
            final String reference, final byte[] imageData)
    {
        ...
        final Label message = new Label("<b>An error has occurred (" + causeClass + ").<br><br>Reference:</b> " + reference);
    ...
    private void generateEmail(final Date time, final String finalId, final String finalTrace, final String reference,
            final String notes, final String supportEmail, final String viewClass, final String user, final String userEmail,
