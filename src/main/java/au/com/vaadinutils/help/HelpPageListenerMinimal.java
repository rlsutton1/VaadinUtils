...
public interface HelpPageListenerMinimal
{
	/**
	 ...
	 * 
	 * this way Compoents that implement HelpPageListenerMinimal will be automatically
	 * provided with the HelpPageListenerMinimal to pass through the calls to setHelp
	 * 
