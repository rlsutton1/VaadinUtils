...
public class HelpSplitPanel extends HorizontalSplitPanel implements View, HelpPageListener
{
	...
	private HorizontalLayout helpHolder = new HorizontalLayout();
	...
	public void setHelp(final Enum<?> helpId)
	{
		...
		helpHolder = new HorizontalLayout();

		Label helpLabel = new Label(FontAwesome.INFO_CIRCLE.getHtml());
		helpLabel.setDescription("Click for help");
		helpLabel.setContentMode(ContentMode.HTML);
		helpLabel.setWidth("20px");
		helpLabel.setHeight("20px");
		helpLabel.setStyleName("help-panel-icon");
		helpHolder.addComponent(helpLabel);
