...
{
	private static final String BUTTON_WIDTH = "50";
	...
	private Component getOptionsPanel()
	{
		...
		showButton.addStyleName(ValoTheme.BUTTON_QUIET);
		...
		printButton.addStyleName(ValoTheme.BUTTON_QUIET);
		...
		exportButton.addStyleName(ValoTheme.BUTTON_QUIET);
	...
	private void createScheduleButton(String buttonHeight, HorizontalLayout buttonContainer)
	{
		...
		scheduleButton.addStyleName(ValoTheme.BUTTON_QUIET);
